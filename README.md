...
### menu(zmenu系統)
menu 是日出自製的選單系統，基層為zmenu，截至目前，選單系統所有最新檔案已經放置於 /MENU(已套用CustomModelData) 底下。材質師製作材質時，請依照 [選單材質製作指南](/選單材質製作指南.md) 內部所記載之資料完成製作，避免材質無法正常適配選單系統。
...
- CustomAddon 烤鴨可透過 CustomModelData 來辨識，對應關係如下：
  ...
  - 銅板烤鴨 → 610005
  - 獄碴烤鴨 → 610006
- menu 選單可透過 CustomModelData 來辨識，對應關係請參照[選單材質製作指南](/選單材質製作指南.md)
## 使用說明
